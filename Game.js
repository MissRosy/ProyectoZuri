class Game{
  ...
  //ESTA FUNCION ES PARA VOLVER CUALQUIER AUTO PEQUEÑO
  pequeña(sprite){
    for (i = 0; i < 50; i++) {
    sprite.scale=0.02;
    }
  ...
  play(){
   ...
   //PASE LOS DOS IF ELSE DE IZQUIERDA-DERECHA PARA ADENTRO DEL FOR.
   //AHORA SI YA SE MUEVEN LOS DOS AUTOS BIEN
         ...
         //ESTE IF ES PARA CUANDO EL AUTO TOCA LA BANANA SE MUEVA MÁS RÁPIDO
         ...
         //ESTOS IF ELSE SON PARA CUANDO LOS AUTOS TOCAN LA ROCA SE VUELVAN PEQUEÑOS COMO SI LOS APLASTARÁ
         if(car1.isTouching(banana)){
            this.pequeña(car1);
          }
         else if(i >= 50 && player.distance >= 2430){
          car1.scale = 0.05; 
         }
         if(car2.isTouching(banana)){
          this.pequeña(car2);
        }
       else if(i >= 50 && player.distance >= 2430){
        car2.scale = 0.05; 
